...
require (
	...
	github.com/kyma-project/kyma-environment-broker v0.0.0-20240912070114-8408e124860d
...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20240329103248-7710e72be80a // indirect
