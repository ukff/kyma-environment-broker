...
func TestResponseLabels(t *testing.T) {
	...
	t.Run("should return labels with expire info for not expired instance", func(t *testing.T) {
		...
		// when
		labels := ResponseLabelsWithExpirationInfo(operation, instance, "https://example.com", "https://trial.docs.local", true, trialDocsKey, trialExpireDuration, trialExpiryDetailsKey, trialExpiredInfoFormat)
