...
func NewProvisioningProperties(machineTypesDisplay map[string]string, machineTypes, regions []string, regionParameterIsRequired, update bool) ProvisioningProperties {
